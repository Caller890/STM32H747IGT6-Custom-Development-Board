...
\- M7\_CDC\_User ths allows serial settings to remain in the event of the .ioc file being updated by the user, any code outside user begin will be automaatically remove from the source code, therefore CDC_user ensures safe guarding critical code to serial print.
